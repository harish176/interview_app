...
function CodeBlock({code, language}){
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray">
            ...
            <button
                onClick={copyCode}
                className="text-gray-500 hover:text-gray-200 focus:outline-none relative group"
